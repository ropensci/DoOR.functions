...
# data(Or22a)
# new.Or22a <- combine_data(data1 = Or22a, data2 = newdata, by.data2 = "new.data")
#
combine_data <- function(data1, data2, by.data2, assigned.name, ident = door_default_values("ident"))
{
