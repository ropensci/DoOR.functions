...
## Mapping response data from an unknown source with `mapReceptor()`{#mapReceptor}
Similar to `identify_sensillum()`, `mapReceptor()` correlates a response vector to all responding units of the existing DoOR consensus data. Let's grab a data set from Or22a and see where it ends up:
```{r}
